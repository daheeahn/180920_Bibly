...
public class TabFragment2_button2 extends AppCompatActivity {
...
//    ImageView fragment_2_button_toolbar_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tab_fragment_2_button_2);

        ButterKnife.bind(this);

        fragment_2_button_toolbar_text.setText(R.string.tab_fragment_2_button_2_text);

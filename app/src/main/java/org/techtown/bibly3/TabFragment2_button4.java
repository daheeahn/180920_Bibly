...
public class TabFragment2_button4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tab_fragment_2_button_4);

        ButterKnife.bind(this);

        fragment_2_button_toolbar_text.setText(R.string.tab_fragment_2_button_4_text);
